        ...
        .then(function (coords) {
            ...
            fetch(requestUrl)
                ...
                .then(function (data) {
                    ...
                    document.querySelector('.current .l1').textContent = 'Temp: ' + (data.main.temp - 273.15).toFixed(1) + '°C';
            ...
            fetch(requestUrl2)
                ...
                .then(function (data) {
                    ...
                    document.querySelector('.c1 .l2').textContent = 'Temp: ' + (fiveDayForecast[0].main.temp - 273.15).toFixed(1) + '°C';
                    ...
                    document.querySelector('.c2 .l2').textContent = 'Temp: ' + (fiveDayForecast[1].main.temp - 273.15).toFixed(1) + '°C';
                    ...
                    document.querySelector('.c3 .l2').textContent = 'Temp: ' + (fiveDayForecast[2].main.temp - 273.15).toFixed(1) + '°C';
                    ...
                    document.querySelector('.c4 .l2').textContent = 'Temp: ' + ((fiveDayForecast[3].main.temp - 273.15).toFixed(1)) + '°C';
                    ...
                    document.querySelector('.c5 .l2').textContent = 'Temp: ' + ((fiveDayForecast[4].main.temp - 273.15).toFixed(1)) + '°C';
